...
//     constructor(address _DINO, uint256 _dinoPerBlock, uint256 _startBlock, uint256 _endBlock) public {
//         DINO = IERC20(_DINO);
...
//     /**
//      * @dev Safe transfer function, just in case if rounding error causes the Fossil Farm to not have enough DINO.
